report 50016 "RTGS/NEFT"
{
    ...
    dataset
    {
        dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
        {
            ...
            column(PrintDoc_VLE; '')//"Vendor Ledger Entry"."Print Document") PCPL-064
            {
            }
            ...
            begin
                ...
                CALCFIELDS("Vendor Ledger Entry"."Remaining Amt. (LCY)");
                //OriginalAmount := "Vendor Ledger Entry"."Original Amount";
                OriginalAmount := "Vendor Ledger Entry"."Remaining Amt. (LCY)";

                Allfields := 'N' + ',' + ',' + bankAccNo + ',' + FORMAT(ABS(OriginalAmount), 0, 1) + ',' + recVendor.Name + ',' + ',' + ',' + rec_VendorBankAccount.Address + ',' + rec_VendorBankAccount."Address 2" + ',' + ',' + ',' + ',' + ',' + 'Pmt Agst Inv' + ',' + "Vendor Ledger Entry"."External Document No." + ',' + ',' + ',' + ',' + ',' + ',' + ',' + ',' + FORMAT(WORKDATE, 0, '<Day,2>/<Month,2>/<Year4>') + ',' + ',' + BankIFSC + ',' + rec_VendorBankAccount.Name + ',' + ',' + BankBranch/*+','*/+ recVendor."E-Mail";
