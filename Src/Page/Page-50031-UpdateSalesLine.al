    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Amount Added to Excise Base"; '')// Rec."Amount Added to Excise Base")//pcpl-065
                {
                }
                field("Amount Added to Tax Base"; '')// Rec."Amount Added to Tax Base")//pcpl-065
                {
                }
                ...
                field("Direct Debit To PLA / RG"; '')// Rec."Direct Debit To PLA / RG")//pcpl-065
                {
                }
                ...
                field("Unit Price Incl. of Tax"; '')// Rec."Unit Price Incl. of Tax")//pcpl-065
                {
                }
                ...
                field("Excise Effective Rate"; '')// Rec."Excise Effective Rate")//pcpl-065
                {
                }
