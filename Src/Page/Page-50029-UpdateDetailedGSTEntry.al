page 50029 "Update Detailed GST Entry"
{
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Sales Invoice Type"; '')// Rec."Sales Invoice Type")//pcpl-065
                {
                }
                ...
                field("Reconciliation Month"; '')// "Reconciliation Month")//pcpl-065
                {
                }
                ...
                field("Delivery Challan Amount"; '')// Rec."Delivery Challan Amount")//pcpl-065
                {
                }
                field("Liable to Pay"; Rec."Liable to Pay")
                {
                }
                field("Subcon Document No."; '')// Rec."Subcon Document No.")//pcpl-065
                {
                }
                field("Last Credit Adjusted Date"; '')// Rec."Last Credit Adjusted Date")//pcpl-065
                {
                }
                field("Dist. Input GST Credit"; Rec."Dist. Input GST Credit")
                {
                }
                field("Component Calc. Type"; '')// Rec."Component Calc. Type")//pcpl-065
                {
                }
                field("Cess Amount Per Unit Factor"; '')// Rec."Cess Amount Per Unit Factor")//pcpl-065
                {
                }
                field("Cess UOM"; '')// Rec."Cess UOM")//pcpl-065
                {
                }
                field("Cess Factor Quantity"; '')// Rec."Cess Factor Quantity")//pcpl-065
                {
                }
                field("Dist. Reverse Document No."; Rec."Dist. Reverse Document No.")
                {
                }
                field(UOM; '')// Rec.UOM)//pcpl-065
                {
                }
